package com.bristol.snorediaby.snores;
...
public class CustomMp3Recorder extends BaseRecorder {
    ...
    private static final String TAG = "CustomMp3Recorder";
    ...
    private void initAudioRecorder() throws IOException {
        ...
        this.mAudioRecord =
            new AudioRecord(DEFAULT_AUDIO_SOURCE, DEFAULT_SAMPLING_RATE, DEFAULT_CHANNEL_CONFIG, DEFAULT_AUDIO_FORMAT.getAudioFormat(),
                this.mBufferSize);
